      ...
      <Navbar className="nav-bg" expand="lg">
        <Container>
          <Navbar.Brand to="/home">
            ...
            <h2 className="d-inline-flex title-heading">MediCare</h2>
          </Navbar.Brand>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="ms-auto">
              ...
              <NavLink className="nav-style" to="/news">
                News
              </NavLink>
              {!user.displayName ?
                (
                  ...
                  <>
                    <span className="fw-bold d-flex justify-content-center align-items-center user-name">{user.displayName}</span>
